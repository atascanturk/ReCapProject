...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //CustomerDataResultTest();
            //DataResultSuccessMessageTest();
            //SuccessMessageTest();
            //GetAllByBrandIdTest();
            //GetCarDetailsDtoTest();
            //GetAllTest();
        ...
        //private static void CustomerDataResultTest()
        //{
        //    CustomerManager customerManager = new CustomerManager(new EfCustomerDal());
        ...
        //private static void DataResultSuccessMessageTest()
        //{
        //    BrandManager brandManager = new BrandManager(new EfBrandDal());
        ...
        //private static void SuccessMessageTest()
        //{
        //    BrandManager brandManager = new BrandManager(new EfBrandDal());
        //    var result = brandManager.Add(new Brand { BrandName = "Dodge" });

        //        Console.WriteLine(result.Message);

        //}

        //private static void GetAllByBrandIdTest()
        //{
        //    CarManager carManager = new CarManager(new EfCarDal());
        ...
        //private static void GetCarDetailsDtoTest()
        //{
        //    CarManager carManager = new CarManager(new EfCarDal());
